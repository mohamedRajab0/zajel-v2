...
router.register(r'friends_requests', views.FriendRequestViewSet, basename='friends_requests')

urlpatterns = [
    path("api/", include(router.urls)),
    path('listRequests', views.list_all_incoming_requests, name='listRequests'),
    path('listOutGoingRequests', views.list_all_outgoing_requests, name='listOutGoingRequests'),
